"""
PyTorch-based Mask Detection Module
Uses trained CNN model for mask detection
"""
import cv2
import numpy as np
import torch
...
class MaskDetectorPyTorch:
    """Mask detector using trained PyTorch model"""
    
    def __init__(self, threshold=0.5, model_path='models/mask_detector.pth'):
        """
        Initialize the PyTorch-based mask detector
        ...
        # Load model
        self.model = MaskDetectorCNN().to(self.device)
    ...
    def detect_mask(self, face_roi):
        ...
        try:
            ...
            with torch.no_grad():
                ...
                confidence = probabilities[0][0].item()  # with_mask probability
                
            has_mask = confidence > self.threshold
