"""
Helmet Detection Model Training Script using PyTorch
Trains a CNN model to detect helmets
"""
import os
import numpy as np
...
EPOCHS = 20
LEARNING_RATE = 0.001
DATASET_PATH = 'helmet dataset/data'
MODEL_SAVE_PATH = 'models/helmet_detector.pth'
HISTORY_SAVE_PATH = 'models/helmet_training_history.json'
...
def train_model():
    ...
    # Create model
    model = HelmetDetectorCNN().to(device)
...
def plot_training_history(history):
    ...
    plt.tight_layout()
    plt.savefig('models/helmet_training_plot.png', dpi=150)
    print("Training plot saved to: models/helmet_training_plot.png")
    plt.close()
