"""
Mask Detection Model Training Script using PyTorch
Trains a CNN model to detect face masks
"""
import os
import numpy as np
...
EPOCHS = 20
LEARNING_RATE = 0.001
DATASET_PATH = 'mask dataset/data'
MODEL_SAVE_PATH = 'models/mask_detector.pth'
HISTORY_SAVE_PATH = 'models/mask_training_history.json'
...
def train_model():
    ...
    print("=" * 60)
    print("MASK DETECTION MODEL TRAINING")
    print("=" * 60)
...
def plot_training_history(history):
    ...
    plt.tight_layout()
    plt.savefig('models/mask_training_plot.png', dpi=150)
    print("Training plot saved to: models/mask_training_plot.png")
    plt.close()
